...
class SimpleLangModel(object):
    ...
    def getGram3Prob(self, word_id_1, word_id_2, word_id_3):
        countsGram2 = self.gram2.get((word_id_1, word_id_2), 0) + self.totalWords
        countsGram3 = self.gram3.get((word_id_1, word_id_2, word_id_3), 0) + SimpleLangModel.K
